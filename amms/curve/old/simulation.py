# taken from: https://github.com/curvefi/curve-contract/blob/master/tests/simulation.py
# credit to: https://github.com/curvefi/
# LICENSE: https://github.com/curvefi/curve-contract/blob/master/LICENSE
