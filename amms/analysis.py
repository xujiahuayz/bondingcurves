...
class Analysis:
    ...
    def plot_slippage(self):
        ...
        for qty_in in slippage_domain:
            ...
            slippage_curve_A_1.append(self.curve_A_1.slippage(qty_in, 0, 1))
            slippage_curve_A_5.append(self.curve_A_5.slippage(qty_in, 0, 1))
            slippage_curve_A_100.append(self.curve_A_100.slippage(qty_in, 0, 1))
    ...
    def plot_divergence_loss(self):
        ...
        domain = np.arange(-0.999999 * X2, 5.1 * X2, 1)
